package com.thetechmaddy.todolistapp.callbacks;
...
public class SwipeToDeleteCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public SwipeToDeleteCallback(TodoListAdapter todoListAdapter) {
        ...
        this.icon = ContextCompat.getDrawable(todoListAdapter.getContext(), R.drawable.ic_delete_white);
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        this.todoListAdapter.deleteTodo(position, viewHolder.itemView);
    }
